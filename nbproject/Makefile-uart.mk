...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/hardware_initializers/pic32mm0256gpm064_explorer_16.o: hardware_initializers/pic32mm0256gpm064_explorer_16.c  .generated_files/flags/uart/50b81f70cb8536a7de73dff397202ea8e5eef32b .generated_files/flags/uart/aee838e5dba634819b3629384be35de812dc739e
	...
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -Wall -MP -MMD -MF "${OBJECTDIR}/hardware_initializers/pic32mm0256gpm064_explorer_16.o.d" -o ${OBJECTDIR}/hardware_initializers/pic32mm0256gpm064_explorer_16.o hardware_initializers/pic32mm0256gpm064_explorer_16.c    -DXPRJ_uart=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -G 8192 -mbranch-cost=1   
	
${OBJECTDIR}/main.o: main.c  .generated_files/flags/uart/5ec47f05e66538981ec183c7b9c49e5acd0a2d7b .generated_files/flags/uart/aee838e5dba634819b3629384be35de812dc739e
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/main.o.d 
	@${RM} ${OBJECTDIR}/main.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -Wall -MP -MMD -MF "${OBJECTDIR}/main.o.d" -o ${OBJECTDIR}/main.o main.c    -DXPRJ_uart=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -G 8192 -mbranch-cost=1   
	
${OBJECTDIR}/EZBL_Install2Flash.o: EZBL_Install2Flash.c  .generated_files/flags/uart/445febf872dd5f11b475eb8d20b9a92378afd581 .generated_files/flags/uart/aee838e5dba634819b3629384be35de812dc739e
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/EZBL_Install2Flash.o.d 
	@${RM} ${OBJECTDIR}/EZBL_Install2Flash.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -Wall -MP -MMD -MF "${OBJECTDIR}/EZBL_Install2Flash.o.d" -o ${OBJECTDIR}/EZBL_Install2Flash.o EZBL_Install2Flash.c    -DXPRJ_uart=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -G 8192 -mbranch-cost=1   
	
${OBJECTDIR}/uart2_fifo.o: uart2_fifo.c  .generated_files/flags/uart/677f1f271bad1d154c90b6557f943898d89b9e95 .generated_files/flags/uart/aee838e5dba634819b3629384be35de812dc739e
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/uart2_fifo.o.d 
	@${RM} ${OBJECTDIR}/uart2_fifo.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -Wall -MP -MMD -MF "${OBJECTDIR}/uart2_fifo.o.d" -o ${OBJECTDIR}/uart2_fifo.o uart2_fifo.c    -DXPRJ_uart=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -G 8192 -mbranch-cost=1   
...
###<EZBL MODIFIED 0>###
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) -g -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION) -O1 -o "/home/u/MPLABXProjects/BL/ex_boot_uart_pic32mm/ezbl_integration/ezbl_partial_link.elf" ${OBJECTFILES_QUOTED_IF_SPACED}    ezbl_integration/ezbl_lib32mm.a      -DXPRJ_uart=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)   -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC00490:0x1FC016FF -mreserve=boot@0x1FC00490:0x1FC00BEF  -Wl,-DEZBL_PASS_1_LINK,--no-check-sections,--defsym=EZBL_BOOT_PROJECT=1,-DEZBL_BOOT_PROJECT=EZBL_BOOT_PROJECT,-D__$(MP_PROCESSOR_OPTION)__=1,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=__MPLAB_DEBUGGER_PK3=1,--defsym=_min_stack_size=3072,--gc-sections,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml  1>/dev/null
...
###</EZBL MODIFIED 0>###
	${MP_CC} $(MP_EXTRA_LD_PRE) -g -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION) -O1 -o dist/${CND_CONF}/${IMAGE_TYPE}/ex_boot_uart_pic32mm.${IMAGE_TYPE}.$(DEBUGGABLE_SUFFIX) ${OBJECTFILES_QUOTED_IF_SPACED}    ezbl_integration/ezbl_lib32mm.a      -DXPRJ_uart=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)   -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC00490:0x1FC016FF -mreserve=boot@0x1FC00490:0x1FC00BEF  -Wl,--defsym=EZBL_BOOT_PROJECT=1,-DEZBL_BOOT_PROJECT=EZBL_BOOT_PROJECT,-D__$(MP_PROCESSOR_OPTION)__=1,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=__MPLAB_DEBUGGER_PK3=1,--defsym=_min_stack_size=3072,--gc-sections,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml 
###<EZBL MODIFIED 0>###
